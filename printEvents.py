...
#infile = TFile('Sync_94X.root','READ')
infile = TFile('/raid/raid7/lucien/Higgs/DarkZ-NTuple/20180731/Sync_Run2017Data_AhmadInput_v1/Data_Run2017_noDuplicates.root','READ')
#infile = TFile('/raid/raid7/dsperka/Run2/Zprime/SingleDoubleMuon_Run2017-17Nov2017-v1_NoDuplicates.root','READ')
ext=''
#ext='_shortest'
#ext='_70to110'
ext='_shortnorefit'
...
with open('eventsBUF_Sync94X'+ext+'.txt','w') as f:
#with open('eventsBUF_Sync94X'+ext+'_data.txt','w') as f:
  ...
  for i in xrange(nevents):
    ...
    if (ext=='_150to300' and not (t.mass4l>150.0 and t.mass4l<300.0)): continue
    ...
    #if (t.mass4e<0.0): continue
    if not (t.mass4l>70.0 and t.mass4l<110.0): continue
    ...
    elif (ext=='_shortnorefit'):
      f.write('{}:{}:{}:{:.2f}:{:.2f}:{:.2f}'.format(t.Run,t.LumiSect,t.Event,t.mass4l,t.massZ1,t.massZ2,)+'\n')
    elif (ext=='_norefit'):
