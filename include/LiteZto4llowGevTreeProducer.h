#ifndef LiteZto4llowGevTreeProducer_h
#define LiteZto4llowGevTreeProducer_h

#include "LiteZto4llowGevTreeProducer_Linkdef.h"
#include "Analyzer.h"
#include "HZZTree.h"
#include "deltaR.h"
...
class LiteZto4llowGevTreeProducer : public Analyzer 
{
    public:
        // static const double Zmass = 91.1876;
        const double Zmass = 91.1876;

        LiteZto4llowGevTreeProducer();
        ~LiteZto4llowGevTreeProducer();
        LiteZto4llowGevTreeProducer(
...
LiteZto4llowGevTreeProducer::LiteZto4llowGevTreeProducer(){
...
bool LiteZto4llowGevTreeProducer::passSelection(){
    return true;
}


void LiteZto4llowGevTreeProducer::initTree(){
    setHZZTree(tree);
}

void LiteZto4llowGevTreeProducer::setDebugMode(bool debug_in){
    debug = debug_in;
}

void LiteZto4llowGevTreeProducer::setup(){
...
void LiteZto4llowGevTreeProducer::end(){
    outFile->cd();
...
int LiteZto4llowGevTreeProducer::process(){
