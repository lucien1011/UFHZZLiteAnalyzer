#ifndef LiteHZZTreeProducer_h
#define LiteHZZTreeProducer_h

#include "LiteHZZTreeProducer_Linkdef.h"
#include "Analyzer.h"
#include "HZZTree.h"
#include "deltaR.h"
...
class LiteHZZTreeProducer : public Analyzer 
{
    public:
...
bool LiteHZZTreeProducer::passSelection(){
    return true;
}
...
int LiteHZZTreeProducer::process(){
