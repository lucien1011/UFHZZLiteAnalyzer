#ifndef LiteZto4lfakerateTreeProducer_h
#define LiteZto4lfakerateTreeProducer_h

#include "LiteZto4lfakerateTreeProducer_Linkdef.h"
#include "Analyzer.h"
...
class LiteZto4lfakerateTreeProducer : public Analyzer 
{
    public:
        // static const double Zmass = 91.1876;
        const double Zmass = 91.1876;

        LiteZto4lfakerateTreeProducer();
        ~LiteZto4lfakerateTreeProducer();
        LiteZto4lfakerateTreeProducer(
...
LiteZto4lfakerateTreeProducer::LiteZto4lfakerateTreeProducer(){
...
bool LiteZto4lfakerateTreeProducer::passSelection(){
    return true;
}


void LiteZto4lfakerateTreeProducer::initTree(){
    setHZZTree(tree);
}

void LiteZto4lfakerateTreeProducer::setDebugMode(bool debug_in){
    debug = debug_in;
}

void LiteZto4lfakerateTreeProducer::setup(){
...
void LiteZto4lfakerateTreeProducer::end(){
    outFile->cd();
...
int LiteZto4lfakerateTreeProducer::process(){
    ...
    if (foundHiggsCandidate) {
        ...
        IsoL1 = (*lep_RelIso)[lep_Hindex[0]]; IsoL2 = (*lep_RelIso)[lep_Hindex[1]];
        IsoL3 = (*lep_RelIso)[lep_Hindex[2]]; IsoL4 = (*lep_RelIso)[lep_Hindex[3]];
        massL1 = (*lep_RelIso)[lep_Hindex[0]]; massL2 = (*lep_mass)[lep_Hindex[1]];
        massL3 = (*lep_mass)[lep_Hindex[2]]; massL4 = (*lep_mass)[lep_Hindex[3]];
        MomIdL1 = (*lep_matchedR03_MomId)[lep_Hindex[0]]; MomIdL2 = (*lep_matchedR03_MomId)[lep_Hindex[1]];
        MomIdL3 = (*lep_matchedR03_MomId)[lep_Hindex[2]]; MomIdL4 = (*lep_matchedR03_MomId)[lep_Hindex[3]];
        PDG_IdL1 = (*lep_matchedR03_PdgId)[lep_Hindex[0]]; PDG_IdL2 = (*lep_matchedR03_PdgId)[lep_Hindex[1]];
        PDG_IdL3 = (*lep_matchedR03_PdgId)[lep_Hindex[2]]; PDG_IdL4 = (*lep_matchedR03_PdgId)[lep_Hindex[3]];
        MomMomIdL1 = (*lep_matchedR03_MomMomId)[lep_Hindex[0]]; MomMomIdL2 = (*lep_matchedR03_MomMomId)[lep_Hindex[1]];
        MomMomIdL3 = (*lep_matchedR03_MomMomId)[lep_Hindex[2]]; MomMomIdL4 = (*lep_matchedR03_MomMomId)[lep_Hindex[3]];
