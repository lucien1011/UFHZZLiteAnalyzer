#ifndef LiteZto4lM4ToInfTreeProducer_h
#define LiteZto4lM4ToInfTreeProducer_h

#include "LiteZto4lM4ToInfTreeProducer_Linkdef.h"
#include "Analyzer.h"
...
class LiteZto4lM4ToInfTreeProducer : public Analyzer 
{
    public:
        // static const double Zmass = 91.1876;
        const double Zmass = 91.1876;

        LiteZto4lM4ToInfTreeProducer();
        ~LiteZto4lM4ToInfTreeProducer();
        LiteZto4lM4ToInfTreeProducer(
...
LiteZto4lM4ToInfTreeProducer::LiteZto4lM4ToInfTreeProducer(){
...
bool LiteZto4lM4ToInfTreeProducer::passSelection(){
    return true;
}


void LiteZto4lM4ToInfTreeProducer::initTree(){
    setHZZTree(tree);
}

void LiteZto4lM4ToInfTreeProducer::setDebugMode(bool debug_in){
    debug = debug_in;
}

void LiteZto4lM4ToInfTreeProducer::setup(){
...
void LiteZto4lM4ToInfTreeProducer::end(){
    outFile->cd();
...
int LiteZto4lM4ToInfTreeProducer::process(){
