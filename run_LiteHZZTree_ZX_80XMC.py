...
inputDir_Feb21  = t2_prefix+'/store/user/t2/users/archived/dsperka/Run2/HZZ4l/SubmitArea_13TeV/rootfiles_MC80X_2lskim_M17_Feb21/'
inputDir_Mar11  = t2_prefix+'/store/user/t2/users/archived/dsperka/Run2/HZZ4l/SubmitArea_13TeV/rootfiles_MC80X_2lskim_M17_Mar11/'
...
for fileName in fileNames:
    ana = ROOT.LiteHZZTreeProducer(outputDir,os.path.basename(fileName))
